...
#     --adapter_map "sexual:checkpoints/wan2.1-t2v-1.3b-diffusers/sexual/safe_adapter_epoch10.pt,violent:checkpoints/wan2.1-t2v-1.3b-diffusers/violent/safe_adapter.pt,political:checkpoints/wan2.1-t2v-1.3b-diffusers/political/safe_adapter.pt,disturbing:checkpoints/wan2.1-t2v-1.3b-diffusers/disturbing/safe_adapter.pt" \
...
python infer_adapter.py \
    ...
    --output_dir "out/cogvideox-2b/benign/multi_defense" \
    --adapter_map "sexual:checkpoints/cogvideox-2b/sexual/safe_adapter.pt,violent:checkpoints/cogvideox-2b/violent/safe_adapter.pt,political:checkpoints/cogvideox-2b/political/safe_adapter.pt,disturbing:checkpoints/cogvideox-2b/disturbing/safe_adapter.pt" \
    --cls_ckpt_path "checkpoints/cogvideox-2b/classifier/prompt_classifier.pt" \
    --generate_defense \
    --skip_existing \
