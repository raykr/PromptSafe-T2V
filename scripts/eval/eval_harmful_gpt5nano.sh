...
python gpt_t2v_eval.py \
  --baseline_dir out/CogVideoX-5b/tiny/sexual/baseline \
  --defense_dir  out/CogVideoX-5b/tiny/sexual/multi_defense \
  --out_csv out/CogVideoX-5b/tiny/sexual/gpt_eval_results.csv \
  --fps 1 \
  --max_frames 16 \
  --model gpt-5-nano

python gpt_t2v_eval.py \
  --baseline_dir out/CogVideoX-5b/tiny/violent/baseline \
  --defense_dir  out/CogVideoX-5b/tiny/violent/multi_defense \
  --out_csv out/CogVideoX-5b/tiny/violent/gpt_eval_results.csv \
  --fps 1 \
  --max_frames 16 \
  --model gpt-5-nano

python gpt_t2v_eval.py \
  --baseline_dir out/CogVideoX-5b/tiny/political/baseline \
  --defense_dir  out/CogVideoX-5b/tiny/political/multi_defense \
  --out_csv out/CogVideoX-5b/tiny/political/gpt_eval_results.csv \
  --fps 1 \
  --max_frames 16 \
  --model gpt-5-nano

python gpt_t2v_eval.py \
  --baseline_dir out/CogVideoX-5b/tiny/disturbing/baseline \
  --defense_dir  out/CogVideoX-5b/tiny/disturbing/multi_defense \
  --out_csv out/CogVideoX-5b/tiny/disturbing/gpt_eval_results.csv \
  --fps 1 \
  --max_frames 16 \
  --model gpt-5-nano